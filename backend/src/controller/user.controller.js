...
export async function getRecommendedUsers(req, res) {
    try{
        ...
        res.status(500).json({success:false,message:"Server error while fetching recommended users"});
    }
}
...
export async function acceptFriendRequest(req,res){
    try{
        ...
        res.status(500).json({success:false,message:"Server error while accepting friend request"});
    }
}
...
//can add reject friend request function here
